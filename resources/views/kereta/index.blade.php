          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('kereta.create')}}" class="btn btn-success float-rigth">Tambah</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tr>
                      ...
                      <td>
                          <form action="{{route('kereta.destroy', $data->id) }} " method="post">
                            @method ('delete')
                            @csrf
                            <a href="{{route('kereta.edit',$data->id )}}" class="btn btn-success float-rigth">Ubah</a>
                            <a href="{{route('kereta.show',$data->id )}}" class="btn btn-warning float-rigth">Tampil</a>
