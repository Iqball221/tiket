                    ...
                    <div class ="col-lg-12">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" name="no_hp" value="{{$dataTransaksi->no_hp}}" disabled>
                             ...
                             <div class="panel-body">
                            <label>Kereta</label>
                            <input type="text" class="form-control" name="id_keretaa" value="{{$dataTransaksi->id_kereta}}" disabled>
                             </div>
                             <div class="panel-body">
                            <label>Tiket</label>
                            <input type="text" class="form-control" name="id_tiket" value="{{$dataTransaksi->id_tiket}}" disabled>
                             </div>
                             <div class="panel-body">
