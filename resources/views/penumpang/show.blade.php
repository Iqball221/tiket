                        ...
                        <div class="panel panel-default">
                            ...
                            <form Action="" method="post">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="radio" name="jk"  value="{{$penumpang->jk}}" disabled>
                                n
                                </div>
                                <div class="panel-body">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="text" name="jenis_tiket"  value="{{$penumpang->jenis_tiket}}" disabled>
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type="date" class="form-control" name="tgl_berangkat" value="{{penumpang->tgl_berangkat}}"disabled>
                                </div>
                                <div class="panel-body">
                                    <label>Jumlah </label>
                                   <input type="number" class="form-control" name="jumlah" value="{{penumpang->jumlah}}"disabled>
                                </div>
                                <div class="panel-body">
                                    <label>Total </label>
